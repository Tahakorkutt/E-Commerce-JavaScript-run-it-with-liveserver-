  ...
  resultItemDOM.forEach((item)=>{
    item.addEventListener("click", ()=>{
     ...
     if(id){
        ...
        window.location.href ="single-product.html" //! tıklandığın da gitmesini istediğin sayfa
     }
    })
  })
}
...
function searchFunc(products) {
    ...
    searchInputDOM.addEventListener("input",(e)=>{
        ...
        filtered = products.filter((item)=> item.name.trim().toLowerCase().includes(value)) // ! arama
